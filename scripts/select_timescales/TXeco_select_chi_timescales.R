...
###############################################################################
df$chi[c(71, 93, 313, 324, 326, 480, 505, 507, 508, 524, 526)] <- NA

# 30-day aridity
ai.30 <- lmer(chi ~ ai.30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 60-day aridity
ai.60 <- lmer(chi ~ ai.60 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 90-day aridity
ai.90 <- lmer(chi ~ ai.90 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 15-year aridity
ai.15yr <- lmer(chi ~ ai.15yr + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
###############################################################################
prcp30 <- lmer(chi ~ prcp30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp29 <- lmer(chi ~ prcp29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp28 <- lmer(chi ~ prcp28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp27 <- lmer(chi ~ prcp27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp26 <- lmer(chi ~ prcp26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp25 <- lmer(chi ~ prcp25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp24 <- lmer(chi ~ prcp24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp23 <- lmer(chi ~ prcp23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp22 <- lmer(chi ~ prcp22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp21 <- lmer(chi ~ prcp21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp20 <- lmer(chi ~ prcp20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp19 <- lmer(chi ~ prcp19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp18 <- lmer(chi ~ prcp18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp17 <- lmer(chi ~ prcp17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp16 <- lmer(chi ~ prcp16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp15 <- lmer(chi ~ prcp15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp14 <- lmer(chi ~ prcp14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp13 <- lmer(chi ~ prcp13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp12 <- lmer(chi ~ prcp12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp11 <- lmer(chi ~ prcp11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp10 <- lmer(chi ~ prcp10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp9 <- lmer(chi ~ prcp9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp8 <- lmer(chi ~ prcp8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp7 <- lmer(chi ~ prcp7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp6 <- lmer(chi ~ prcp6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp5 <- lmer(chi ~ prcp5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp4 <- lmer(chi ~ prcp4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp3 <- lmer(chi ~ prcp3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp2 <- lmer(chi ~ prcp2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp1 <- lmer(chi ~ prcp1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
map <- lmer(chi ~ map.15yr + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
prcp30.modelSelect %>% 
  ...
  arrange(AICc)
## 15-year precipitation is best model

###############################################################################
# Iterative models for Tmean and log(narea)
###############################################################################
temp30 <- lmer(chi ~ tavg30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp29 <- lmer(chi ~ tavg29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp28 <- lmer(chi ~ tavg28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp27 <- lmer(chi ~ tavg27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp26 <- lmer(chi ~ tavg26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp25 <- lmer(chi ~ tavg25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp24 <- lmer(chi ~ tavg24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp23 <- lmer(chi ~ tavg23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp22 <- lmer(chi ~ tavg22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp21 <- lmer(chi ~ tavg21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp20 <- lmer(chi ~ tavg20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp19 <- lmer(chi ~ tavg19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp18 <- lmer(chi ~ tavg18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp17 <- lmer(chi ~ tavg17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp16 <- lmer(chi ~ tavg16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp15 <- lmer(chi ~ tavg15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp14 <- lmer(chi ~ tavg14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp13 <- lmer(chi ~ tavg13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp12 <- lmer(chi ~ tavg12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp11 <- lmer(chi ~ tavg11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp10 <- lmer(chi ~ tavg10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp9 <- lmer(chi ~ tavg9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp8 <- lmer(chi ~ tavg8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp7 <- lmer(chi ~ tavg7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp6 <- lmer(chi ~ tavg6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp5 <- lmer(chi ~ tavg5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp4 <- lmer(chi ~ tavg4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp3 <- lmer(chi ~ tavg3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp2 <- lmer(chi ~ tavg2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp1 <- lmer(chi ~ tavg1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
mat <- lmer(chi ~ mat.15yr + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
temp30.modelSelect %>% 
  ...
  arrange(AICc)
## 13-day temperature is best model

###############################################################################
# VPD
###############################################################################
vpd30 <- lmer(chi ~ vpd30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd29 <- lmer(chi ~ vpd29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd28 <- lmer(chi ~ vpd28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd27 <- lmer(chi ~ vpd27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd26 <- lmer(chi ~ vpd26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd25 <- lmer(chi ~ vpd25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd24 <- lmer(chi ~ vpd24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd23 <- lmer(chi ~ vpd23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd22 <- lmer(chi ~ vpd22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd21 <- lmer(chi ~ vpd21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd20 <- lmer(chi ~ vpd20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd19 <- lmer(chi ~ vpd19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd18 <- lmer(chi ~ vpd18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd17 <- lmer(chi ~ vpd17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd16 <- lmer(chi ~ vpd16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd15 <- lmer(chi ~ vpd15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd14 <- lmer(chi ~ vpd14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd13 <- lmer(chi ~ vpd13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd12 <- lmer(chi ~ vpd12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd11 <- lmer(chi ~ vpd11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd10 <- lmer(chi ~ vpd10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd9 <- lmer(chi ~ vpd9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd8 <- lmer(chi ~ vpd8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd7 <- lmer(chi ~ vpd7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd6 <- lmer(chi ~ vpd6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd5 <- lmer(chi ~ vpd5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd4 <- lmer(chi ~ vpd4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd3 <- lmer(chi ~ vpd3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd2 <- lmer(chi ~ vpd2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd1 <- lmer(chi ~ vpd1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
mav <- lmer(chi ~ mav.15yr + (1 | sampling.year) + (1 | NCRS.code), data = df)
