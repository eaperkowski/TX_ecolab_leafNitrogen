...
# 30-day aridity
ai.30 <- lmer(log(narea) ~ ai.30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 60-day aridity
ai.60 <- lmer(log(narea) ~ ai.60 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 90-day aridity
ai.90 <- lmer(log(narea) ~ ai.90 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 15-year aridity
ai.15yr <- lmer(log(narea) ~ ai.15yr + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
ai.30_modelSelect %>% full_join(ai.60_modelSelect) %>% 
  ...
  arrange(AICc)
## 15-year aridity is the best model

###############################################################################
# Precipitation AICc for log(narea)
###############################################################################
prcp30 <- lmer(log(narea) ~ prcp30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp29 <- lmer(log(narea) ~ prcp29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp28 <- lmer(log(narea) ~ prcp28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp27 <- lmer(log(narea) ~ prcp27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp26 <- lmer(log(narea) ~ prcp26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp25 <- lmer(log(narea) ~ prcp25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp24 <- lmer(log(narea) ~ prcp24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp23 <- lmer(log(narea) ~ prcp23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp22 <- lmer(log(narea) ~ prcp22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp21 <- lmer(log(narea) ~ prcp21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp20 <- lmer(log(narea) ~ prcp20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp19 <- lmer(log(narea) ~ prcp19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp18 <- lmer(log(narea) ~ prcp18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp17 <- lmer(log(narea) ~ prcp17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp16 <- lmer(log(narea) ~ prcp16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp15 <- lmer(log(narea) ~ prcp15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp14 <- lmer(log(narea) ~ prcp14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp13 <- lmer(log(narea) ~ prcp13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp12 <- lmer(log(narea) ~ prcp12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp11 <- lmer(log(narea) ~ prcp11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp10 <- lmer(log(narea) ~ prcp10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp9 <- lmer(log(narea) ~ prcp9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp8 <- lmer(log(narea) ~ prcp8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp7 <- lmer(log(narea) ~ prcp7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp6 <- lmer(log(narea) ~ prcp6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp5 <- lmer(log(narea) ~ prcp5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp4 <- lmer(log(narea) ~ prcp4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp3 <- lmer(log(narea) ~ prcp3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp2 <- lmer(log(narea) ~ prcp2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp1 <- lmer(log(narea) ~ prcp1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
prcp30.modelSelect %>% full_join(prcp29.modelSelect) %>% 
  ...
  arrange(AICc)
## 15-day precipitation is best model

###############################################################################
# Iterative models for Tmean and log(narea)
###############################################################################
temp30 <- lmer(log(narea) ~ tavg30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp29 <- lmer(log(narea) ~ tavg29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp28 <- lmer(log(narea) ~ tavg28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp27 <- lmer(log(narea) ~ tavg27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp26 <- lmer(log(narea) ~ tavg26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp25 <- lmer(log(narea) ~ tavg25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp24 <- lmer(log(narea) ~ tavg24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp23 <- lmer(log(narea) ~ tavg23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp22 <- lmer(log(narea) ~ tavg22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp21 <- lmer(log(narea) ~ tavg21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp20 <- lmer(log(narea) ~ tavg20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp19 <- lmer(log(narea) ~ tavg19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp18 <- lmer(log(narea) ~ tavg18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp17 <- lmer(log(narea) ~ tavg17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp16 <- lmer(log(narea) ~ tavg16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp15 <- lmer(log(narea) ~ tavg15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp14 <- lmer(log(narea) ~ tavg14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp13 <- lmer(log(narea) ~ tavg13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp12 <- lmer(log(narea) ~ tavg12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp11 <- lmer(log(narea) ~ tavg11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp10 <- lmer(log(narea) ~ tavg10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp9 <- lmer(log(narea) ~ tavg9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp8 <- lmer(log(narea) ~ tavg8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp7 <- lmer(log(narea) ~ tavg7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp6 <- lmer(log(narea) ~ tavg6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp5 <- lmer(log(narea) ~ tavg5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp4 <- lmer(log(narea) ~ tavg4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp3 <- lmer(log(narea) ~ tavg3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp2 <- lmer(log(narea) ~ tavg2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp1 <- lmer(log(narea) ~ tavg1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
temp30.modelSelect %>% full_join(temp29.modelSelect) %>% 
  ...
  arrange(AICc)
## 26-day temperature is best model

###############################################################################
# VPD
###############################################################################
vpd30 <- lmer(log(narea) ~ vpd30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd29 <- lmer(log(narea) ~ vpd29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd28 <- lmer(log(narea) ~ vpd28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd27 <- lmer(log(narea) ~ vpd27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd26 <- lmer(log(narea) ~ vpd26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd25 <- lmer(log(narea) ~ vpd25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd24 <- lmer(log(narea) ~ vpd24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd23 <- lmer(log(narea) ~ vpd23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd22 <- lmer(log(narea) ~ vpd22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd21 <- lmer(log(narea) ~ vpd21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd20 <- lmer(log(narea) ~ vpd20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd19 <- lmer(log(narea) ~ vpd19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd18 <- lmer(log(narea) ~ vpd18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd17 <- lmer(log(narea) ~ vpd17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd16 <- lmer(log(narea) ~ vpd16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd15 <- lmer(log(narea) ~ vpd15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd14 <- lmer(log(narea) ~ vpd14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd13 <- lmer(log(narea) ~ vpd13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd12 <- lmer(log(narea) ~ vpd12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd11 <- lmer(log(narea) ~ vpd11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd10 <- lmer(log(narea) ~ vpd10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd9 <- lmer(log(narea) ~ vpd9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd8 <- lmer(log(narea) ~ vpd8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd7 <- lmer(log(narea) ~ vpd7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd6 <- lmer(log(narea) ~ vpd6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd5 <- lmer(log(narea) ~ vpd5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd4 <- lmer(log(narea) ~ vpd4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd3 <- lmer(log(narea) ~ vpd3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd2 <- lmer(log(narea) ~ vpd2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd1 <- lmer(log(narea) ~ vpd1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
mav <- lmer(log(narea) ~ mav.15yr + (1 | sampling.year) + (1 | NCRS.code), data = df)
