...
###############################################################################
df$n.leaf[c(384, 533)] <- NA

# 30-day aridity
ai.30 <- lmer(log(n.leaf) ~ ai.30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 60-day aridity
ai.60 <- lmer(log(n.leaf) ~ ai.60 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 90-day aridity
ai.90 <- lmer(log(n.leaf) ~ ai.90 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
# 15-year aridity
ai.15yr <- lmer(log(n.leaf) ~ ai.15yr + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
###############################################################################
prcp30 <- lmer(log(n.leaf) ~ prcp30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp29 <- lmer(log(n.leaf) ~ prcp29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp28 <- lmer(log(n.leaf) ~ prcp28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp27 <- lmer(log(n.leaf) ~ prcp27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp26 <- lmer(log(n.leaf) ~ prcp26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp25 <- lmer(log(n.leaf) ~ prcp25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp24 <- lmer(log(n.leaf) ~ prcp24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp23 <- lmer(log(n.leaf) ~ prcp23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp22 <- lmer(log(n.leaf) ~ prcp22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp21 <- lmer(log(n.leaf) ~ prcp21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp20 <- lmer(log(n.leaf) ~ prcp20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp19 <- lmer(log(n.leaf) ~ prcp19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp18 <- lmer(log(n.leaf) ~ prcp18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp17 <- lmer(log(n.leaf) ~ prcp17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp16 <- lmer(log(n.leaf) ~ prcp16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp15 <- lmer(log(n.leaf) ~ prcp15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp14 <- lmer(log(n.leaf) ~ prcp14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp13 <- lmer(log(n.leaf) ~ prcp13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp12 <- lmer(log(n.leaf) ~ prcp12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp11 <- lmer(log(n.leaf) ~ prcp11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp10 <- lmer(log(n.leaf) ~ prcp10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp9 <- lmer(log(n.leaf) ~ prcp9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp8 <- lmer(log(n.leaf) ~ prcp8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp7 <- lmer(log(n.leaf) ~ prcp7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp6 <- lmer(log(n.leaf) ~ prcp6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp5 <- lmer(log(n.leaf) ~ prcp5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp4 <- lmer(log(n.leaf) ~ prcp4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp3 <- lmer(log(n.leaf) ~ prcp3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp2 <- lmer(log(n.leaf) ~ prcp2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
prcp1 <- lmer(log(n.leaf) ~ prcp1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
prcp30.modelSelect %>% full_join(prcp29.modelSelect) %>% 
...
###############################################################################
temp30 <- lmer(log(n.leaf) ~ tavg30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp29 <- lmer(log(n.leaf) ~ tavg29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp28 <- lmer(log(n.leaf) ~ tavg28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp27 <- lmer(log(n.leaf) ~ tavg27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp26 <- lmer(log(n.leaf) ~ tavg26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp25 <- lmer(log(n.leaf) ~ tavg25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp24 <- lmer(log(n.leaf) ~ tavg24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp23 <- lmer(log(n.leaf) ~ tavg23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp22 <- lmer(log(n.leaf) ~ tavg22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp21 <- lmer(log(n.leaf) ~ tavg21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp20 <- lmer(log(n.leaf) ~ tavg20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp19 <- lmer(log(n.leaf) ~ tavg19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp18 <- lmer(log(n.leaf) ~ tavg18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp17 <- lmer(log(n.leaf) ~ tavg17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp16 <- lmer(log(n.leaf) ~ tavg16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp15 <- lmer(log(n.leaf) ~ tavg15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp14 <- lmer(log(n.leaf) ~ tavg14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp13 <- lmer(log(n.leaf) ~ tavg13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp12 <- lmer(log(n.leaf) ~ tavg12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp11 <- lmer(log(n.leaf) ~ tavg11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp10 <- lmer(log(n.leaf) ~ tavg10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp9 <- lmer(log(n.leaf) ~ tavg9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp8 <- lmer(log(n.leaf) ~ tavg8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp7 <- lmer(log(n.leaf) ~ tavg7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp6 <- lmer(log(n.leaf) ~ tavg6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp5 <- lmer(log(n.leaf) ~ tavg5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp4 <- lmer(log(n.leaf) ~ tavg4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp3 <- lmer(log(n.leaf) ~ tavg3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp2 <- lmer(log(n.leaf) ~ tavg2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
temp1 <- lmer(log(n.leaf) ~ tavg1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
...
temp30.modelSelect %>% full_join(temp29.modelSelect) %>% 
  ...
  arrange(AICc)
## 21-day temperature is best model

###############################################################################
# VPD
###############################################################################
vpd30 <- lmer(log(n.leaf) ~ vpd30 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd29 <- lmer(log(n.leaf) ~ vpd29 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd28 <- lmer(log(n.leaf) ~ vpd28 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd27 <- lmer(log(n.leaf) ~ vpd27 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd26 <- lmer(log(n.leaf) ~ vpd26 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd25 <- lmer(log(n.leaf) ~ vpd25 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd24 <- lmer(log(n.leaf) ~ vpd24 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd23 <- lmer(log(n.leaf) ~ vpd23 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd22 <- lmer(log(n.leaf) ~ vpd22 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd21 <- lmer(log(n.leaf) ~ vpd21 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd20 <- lmer(log(n.leaf) ~ vpd20 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd19 <- lmer(log(n.leaf) ~ vpd19 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd18 <- lmer(log(n.leaf) ~ vpd18 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd17 <- lmer(log(n.leaf) ~ vpd17 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd16 <- lmer(log(n.leaf) ~ vpd16 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd15 <- lmer(log(n.leaf) ~ vpd15 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd14 <- lmer(log(n.leaf) ~ vpd14 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd13 <- lmer(log(n.leaf) ~ vpd13 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd12 <- lmer(log(n.leaf) ~ vpd12 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd11 <- lmer(log(n.leaf) ~ vpd11 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd10 <- lmer(log(n.leaf) ~ vpd10 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd9 <- lmer(log(n.leaf) ~ vpd9 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd8 <- lmer(log(n.leaf) ~ vpd8 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd7 <- lmer(log(n.leaf) ~ vpd7 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd6 <- lmer(log(n.leaf) ~ vpd6 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd5 <- lmer(log(n.leaf) ~ vpd5 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd4 <- lmer(log(n.leaf) ~ vpd4 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd3 <- lmer(log(n.leaf) ~ vpd3 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd2 <- lmer(log(n.leaf) ~ vpd2 + (1 | sampling.year) + (1 | NCRS.code), data = df)
vpd1 <- lmer(log(n.leaf) ~ vpd1 + (1 | sampling.year) + (1 | NCRS.code), data = df)
mav <- lmer(log(n.leaf) ~ mav.15yr + (1 | sampling.year) + (1 | NCRS.code), data = df)
